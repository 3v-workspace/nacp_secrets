...
if __name__ == '__main__':
    download(declaration_type=1, declaration_year=2018, page=10)
    download(declaration_type=1, declaration_year=2018, page=20)
    download(declaration_type=1, declaration_year=2018, page=30)
    download(declaration_type=1, declaration_year=2018, page=40)
    download(declaration_type=1, declaration_year=2018, page=50)
    download(declaration_type=1, declaration_year=2018, page=60)
    download(declaration_type=1, declaration_year=2018, page=80)
    download(declaration_type=1, declaration_year=2018, page=90)
    download(declaration_type=1, declaration_year=2018, page=99)
    download(declaration_type=1, declaration_year=2018, page=100)
    print('Done')
